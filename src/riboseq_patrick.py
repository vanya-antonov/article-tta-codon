...
mRNA_sequences = "bowtie/AP009493.1.fasta"
...
#CONTROL RNA
NormGlu1_rna_file = pysam.Samfile("transcriptome/SRR10212831_SgriRibo_E1.bam", 'rb')
NormGlu1_rna_file2 = pysam.Samfile("transcriptome/SRR10212833_SgriRibo_T1.bam", 'rb')
NormGlu1_rna_file3 = pysam.Samfile("transcriptome/SRR10212835_SgriRibo_L1.bam", 'rb')
NormGlu1_rna_file4 = pysam.Samfile("transcriptome/SRR10212837_SgriRibo_S1.bam", 'rb')
